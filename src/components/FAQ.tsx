          ...
          <div className="flex flex-col gap-4">
            ...
            <MagneticWrap>
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="self-start flex items-center gap-3 bg-[#a2b2cf] hover:bg-[#0047FF] text-white text-xs font-bold uppercase tracking-widest px-6 py-3 rounded-full transition-colors"
              >
